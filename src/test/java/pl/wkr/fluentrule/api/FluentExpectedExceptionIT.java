...
import pl.wkr.fluentrule.test_.TCheckExpectedException;

import java.sql.SQLException;

import static pl.wkr.fluentrule.test_.FluentExpectedExceptionHelper.WAS_NOT_THROWN_MESSAGE;
...
public class FluentExpectedExceptionIT {
    ...
    public void fat_example() throws Throwable {
        ...
        thrown.expect()
                ...
                .hasCauseInstanceOf(AnyExc.class)
                .isSameAs(exc)
                .isNotNull()
                .hasMessage("exc")
        ...
        thrown.expectCause(AnyExc.class)
