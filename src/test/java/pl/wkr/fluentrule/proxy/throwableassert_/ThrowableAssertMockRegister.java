...
public interface ThrowableAssertMockRegister {
    ...
    public void is(Condition<? super Throwable> condition);
    public void isNot(Condition<? super Throwable> condition);
    public void has(Condition<? super Throwable> condition);
    public void doesNotHave(Condition<? super Throwable> condition);
    ...
    public void usingComparator(Comparator<? super Throwable> customComparator);
